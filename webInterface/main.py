    ...
    with open(config_file, 'r') as fp:
        ...
        if content_type == "lcd_text_10" or content_type == "lcd_text_11":
            config["boxes"]["program"] = {
                left_percentage: config["boxes"]["lcd_text_10"]["left_percentage"],
                top_percentage: min(config["boxes"]["lcd_text_10"]["top_percentage"], config["boxes"]["lcd_text_11"]["top_percentage"]),

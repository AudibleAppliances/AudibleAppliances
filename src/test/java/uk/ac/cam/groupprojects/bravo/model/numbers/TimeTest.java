...
public class TimeTest {
    ...
    public void testOutput(){
        Time time = new Time();
        time.setValue(50);
        assertEquals( "The current time elapsed is 0 minutes and 50 seconds", time.formatSpeech() );

        time.setValue(1, 30);
        assertEquals( "The current time elapsed is 1 minutes and 30 seconds", time.formatSpeech() );
